...
public class Chapter4 {
    ...
    public static void logic(EntityManager em) {
        ...
        String id = "id1";
        Chapter4Member member = new Chapter4Member();
        member.setId(id);
        ...
        //한 건 조회
        Chapter4Member findMember = em.find(Chapter4Member.class, id);
        ...
        //한 건 조회
        Chapter4Member findMember2 = em.find(Chapter4Member.class, id);
        System.out.println("id= " + id + ", findMember=" + findMember2.getUsername() + ", age=" + findMember2.getAge());

        //목록 조회
        List<Chapter4Member> members = em.createQuery("select a from Chapter4Member a", Chapter4Member.class).getResultList();
